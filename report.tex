...
\newpage
\subsection{Arithmetic and Geometric Mean Filtering}
\subsubsection{Task}
Apply an Arithmetic Mean Filter as well as Geometric Mean Filter to the same input image. Show the input image, the two output images, and the program in the report.
...
\begin{figure}[!ht]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]
		{data/single-fresh-red-strawberry-on-table-green-background-food-fruit-sweet-macro-juicy-plant-image-photo-lumina-arithmetic-mean-filtered.jpg}
		\caption{Output Image (Arithmetic Mean Filtered)}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]
		{data/single-fresh-red-strawberry-on-table-green-background-food-fruit-sweet-macro-juicy-plant-image-photo-lumina-geometric-mean-filtered.jpg}
		\caption{Output Image (Geometric Mean Filtered)}
	\end{subfigure}

	\caption{Comparison of Mean Filtering Techniques}
\end{figure}
