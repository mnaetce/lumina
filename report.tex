...
\begin{figure}[!ht]
	...
	\vspace{1cm}
	\includegraphics[width=0.65\linewidth]
	{data/single-fresh-red-strawberry-on-table-green-background-food-fruit-sweet-macro-juicy-plant-image-photo.jpg-lumina-blurred.jpg}
	...
	for (int y = 0; y < input.height; ++y) {
		for (int x = 0; x < input.width; ++x) {
			for (int c = 0; c < input.channels; ++c) {
				// For each pixel and for each channel in the pixel,
				// Average out the neighbouring pixels
				// For edges of the image, only use the valid pixels.
				...
				// Write the average value of the channel to the output
